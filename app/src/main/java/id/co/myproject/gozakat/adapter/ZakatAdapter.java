...
public class ZakatAdapter extends RecyclerView.Adapter<ZakatAdapter.ViewHolder> {
    ...
    public ZakatAdapter(Context context, ApiRequest apiRequest) {
    ...
    @NonNull
    @Override
    public ZakatAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_aktivitas, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ZakatAdapter.ViewHolder holder, int position) {
